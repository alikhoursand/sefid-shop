...
Route::prefix('user')->middleware('auth')->group(function () {
    ...
    Route::get('/messages', [UserController::class, 'panelMessages'])->name('user.messages');
    Route::post('/messages/read', [UserController::class, 'readMessage'])->name('user.message.read');
