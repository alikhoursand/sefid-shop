...
@section('content')
    <x-admin.page-title :page_title="'تنظیمات سایت'" />
            ...
            <div class="col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-1">
                <form action="{{ route('admin.settings.post.update') }}" method="post">
                    ...
                    <input type="text" id="post-cost" name="post_cost" dir="ltr"
                        class="input focus:outline-none w-full" value="{{ $settings_array['post_cost'] }}" />
            ...
            <div class="col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-1">
                <form action="{{ route('admin.settings.tax.update') }}" method="post">
                    ...
                    <label for="tax" class="block mb-2 text-sm">درصد
                        مالیات</label>
                    <input type="text" id="tax" name="tax_percent" dir="ltr"
                        class="input focus:outline-none w-full" value="{{ $settings_array['tax_percent'] }}" />
                    <button type="submit" class="btn btn-success mr-auto mt-2 block">
                        به
                        روز رسانی
                    </button>
                ...
                <div class="grid gap-4 mb-6 grid-cols-4">
                    ...
                    <div class="col-span-4 xl:col-span-2">
                        <label for="text" class="block mb-2 text-sm">توضیحات فوتر
                            سایت</label>
                        <textarea id="text" rows="4" name="footer_desc" class="textarea w-full focus:outline-none">{{ $settings_array['footer_desc'] }}</textarea>
                    </div>

                    <div class="col-span-4 xl:col-span-2">
                        <label for="address" class="block mb-2 text-sm">آدرس</label>
                        <textarea id="address" rows="4" name="address" class="textarea w-full focus:outline-none">{{ $settings_array['address'] }}</textarea>
                    </div>
                    ...
                    <div class="col-span-4 md:col-span-2 xl:col-span-1">
                        ...
                        <input type="text" id="phone1" name="phone1" dir="ltr"
                            class="input focus:outline-none w-full" value="{{ $settings_array['phone1'] }}" />
                    </div>
                    <div class="col-span-4 md:col-span-2 xl:col-span-1">
                        <label for="phone2" class="block mb-2 text-sm  ">شماره تماس
                            ۲</label>
                        <input type="text" id="phone2" name="phone2" dir="ltr"
                            class="input focus:outline-none w-full" value="{{ $settings_array['phone2'] }}" />
                    </div>
                    <div class="col-span-4 md:col-span-2 xl:col-span-1">
                ...
                <div class="flex mb-6 gap-y-4 flex-wrap">
                    ...
                    <div class="basis-full md:basis-1/2 lg:basis-1/2 xl:basis-1/4 md:pl-2">
                        ...
                        <input type="text" id="telegram-apikey" name="telegram_apikey" dir="ltr"
                            class="input focus:outline-none w-full" value="{{ $settings_array['telegram_apikey'] }}" />
                    </div>
                    <div class="basis-full md:basis-1/2 lg:basis-1/2 xl:basis-1/4 md:pr-2">
                        ...
                        <input type="text" id="telegram-chatid" name="telegram_chatid" dir="ltr"
                            class="input focus:outline-none w-full" value="{{ $settings_array['telegram_chatid'] }}" />
