        ...
        <form action="{{ route('admin.banner.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div class="col-span-1 lg:col-span-2 xl:col-span-1">
                    <img id="imagePreview" src="#" class="hidden aspect-video w-full mt-2 object-cover"
                        alt="Image Preview">
                </div>
    ...
    <div class="flex flex-wrap items-stretch ">
        @foreach ($banners as $banner)
            <div class="2xl:basis-1/5 lg:basis-1/3 md:basis-1/3 2xs:basis-1/2 basis-full p-2 text-sm md:text-base">
                <div
                    class="h-full shadow-md shadow-base-300 bg-base-100 rounded-box overflow-hidden flex flex-col justify-between">
