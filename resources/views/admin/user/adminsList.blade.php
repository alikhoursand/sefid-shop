...
@section('content')
    ...
    <div class="mb-4">
        <form action="{{route('user.admin.search')}}" method="get">
            ...
            @foreach ($admins as $admin)
                <tr class="border-base-300 hover:bg-base-content/10">
                    ...
                    <td class="text-center min-w-[100px]">
                        <div class="p-4">
                            @if ($admin->status == 1)
                                <form action="{{ route('user.change.status', $admin->id) }}" method="post">
                                    @csrf
                                    @method('PUT')
                    ...
                    <td class="text-right min-w-[100px] p-4">
                        <div class="flex justify-center items-center">
                            ...
                            <form id="roleForm-{{ $admin->id }}" class="hidden"
                                  action="{{ route('user.change.role', $admin->id) }}" method="post">
                                @csrf
                                @method('PUT')
                ...
                <form method="dialog">
                    <button class="btn btn-sm btn-circle btn-ghost absolute left-2 top-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <g clip-path="url(#clip0_4418_9821dms)">
                                <path
                            ...
                            <defs>
                                <clipPath id="clip0_4418_9821dms">
