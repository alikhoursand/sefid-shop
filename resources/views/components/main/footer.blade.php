    ...
    <div class="flex flex-wrap items-start justify-between max-w-screen-xl mx-auto">
        <div class="basis-full lg:basis-1/2 ">
            ...
            <div class="flex items-center mt-2 gap-4">
                <a href="https://wa.me/{{ $settings['whatsapp'] }}" class="opacity-75 hover:opacity-100">
                    <svg class="size-7" width="800px" height="800px" viewBox="0 0 24 24" fill="none"
                ...
                <a href="https://t.me/{{ $settings['telegram'] }}" class="opacity-75 hover:opacity-100">
                    <svg class="size-7" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24">
        ...
        <div class="basis-full sm:basis-1/2 lg:basis-1/4 text-center p-4 lg:p-2">
            ...
            <div class="flex flex-col justify-center items-center gap-y-2 mt-4">
                ...
                <a href="{{ route('shop.product.list') }}"
                    class="opacity-75 hover:opacity-100 text-sm w-fit">محصولات</a>
                <a href="{{ auth()->check() ? route('user.panel') : route('login') }}"
                    class="opacity-75 hover:opacity-100 text-sm w-fit">حساب
                    کاربری</a>
            </div>
        </div>
