            ...
            <div class="collapse bg-base-300">
                ...
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <g clip-path="url(#clip0_4418_8580fws)">
                            <path
                        ...
                        <defs>
                            <clipPath id="clip0_4418_8580fws">
...
@push('header_scripts')
    <script>
        ...
        function filtersChanged() {
            ...
            // submit filters
            window.location.href = `{{route('shop.offers')}}?sort=${sort}&avail=${avail}&min_price=${minPrice}&max_price=${maxPrice}&page=${currentPage}`;
